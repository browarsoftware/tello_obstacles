...
# https://github.com/shalomma/DEN
#changed by Tomek - to działa!
...
# Create the model
model = create_model_v3( existing=args.checkpoint )
...
basemodel.save(runPath + '/modelOK.h5')
